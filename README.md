...
|-------------|-------|-------|
| Named Entity Recognition | [NER Examples with GPT-3](NER Examples with GPT-3.ipynb) | ✅  |
| Multi-Label Text Classification | [Classification Examples with GPT-3](Classification Examples with GPT-3.ipynb) | ✅    |
| Multi-Class Text Classification | [Classification Examples with GPT-3](Classification Examples with GPT-3.ipynb) | ✅    |
| Binary Text Classification  | [Classification Examples with GPT-3](Classification Examples with GPT-3.ipynb) | ✅    |
